    ...
    return (
        <Col span={12}>
            ...
            <motion.div 
                    ...
                    viewport={{once: true}}>
                <Image preview={false} src={props.image} style={{'maxWidth': '100%', 'height': 'auto', 'maxHeight': '400px'}}></Image>
            </motion.div>
            </Row>
        </Col>
    )
    ...
    return (
        <Col span={12}>
            <motion.div 
                    ...
                    whileInView={{y: 0, opacity: 1, transition: {type: 'spring', bounce: 0, duration: 1}}} 
                    viewport={{once: true}}>
                <Row justify='start' style={{'padding': '0px 50px'}}>
                    <Typography.Title>
                        {props.title}
                    </Typography.Title>
                </Row>
        ...
        <Layout style={{'minWidth': '1000px'}}>
            <Affix offsetTop={0}>
                <Layout.Header style={{'background': 'white', 'height': '70px'}}>
                    <Row justify='start' align='top' style={{'backgroundColor': 'white', 'height': '100%'}}>
            ...
            <Layout.Content>
                {/* cover headline */}
                <Row justify='center' align='middle' style={{'backgroundColor': 'white', 'padding': '60px 0'}}>
                <Row justify='center' align='middle' style={{'maxWidth': '2000px'}}>
                    <Col style={{'width': '40%'}}>
                        <Row style={{'padding': '0px 50px', 'flexDirection': 'column', 'alignItems': 'flex-start'}}>
                            <Typography.Title>
                                {state.coverTitle}
                            </Typography.Title>
                            <Typography style={{'fontSize': '16px', 'marginTop': '16px'}}>
                                {state.coverText}
                            </Typography>
                        </Row>

                        <Row justify='start' style={{ marginTop: '30px', paddingLeft: '20px' }}>
                            {
                    ...
                    <Col style={{'width': '60%'}}>
                        <Row justify='center'>
                        <Image preview={false} src={state.coverImage} style={{'width': '100%', 'height': 'auto', 'maxWidth': '800px'}}></Image>
                        </Row>
                    </Col>
                </Row>
                </Row>
